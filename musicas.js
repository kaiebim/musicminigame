...
let minadocondominio = {
    musica: "Mina do Condomínio",
    artista: "Seu Jorge",
    letra: [
...
let carolinacarolbela = {
    musica: "Carolina Carol Bela",
    artista: "Jorge Ben Jor",
    letra: [
        ["Que ela mora no meu peito",
            "E eu moro vizinho a ela",
            "Que eu fico desse jeito",
